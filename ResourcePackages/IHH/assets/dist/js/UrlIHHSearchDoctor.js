...
jQuery(()=>{
    ...
    function ShowDoctor(data){
        ...
        for (let index = 0; index < data.length; index++) {
            ...
            {
                if(data[index].SubSpecialtyName.includes(",,"))
                {
                    var splitSpecialty = data[index].SubSpecialtyName.split(',,');

                    for(var i = 0; i < splitSpecialty.length; i++)
                    {
                        addsubspec = addsubspec + '<div class="doctors-texts-sub-specialty">' + splitSpecialty[i].trim() + '</div>';
                    }
                }
                else
                {
                    addsubspec = '<div class="doctors-texts-sub-specialty">' + data[index].SubSpecialtyName + '</div>';
                }   
            }
